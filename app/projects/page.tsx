  ...
  const projects = [
    {
      ...
      description:
        'Complete platform overhaul resulting in 70% faster load times and 35% increase in conversions.',
    ...
    },
    {
      ...
      description:
        'Full brand identity and go-to-market strategy for a SaaS startup, leading to successful Series A.',
    ...
    },
    {
      ...
      description:
        '6-episode documentary series showcasing company impact, generating 2M+ views.',
    ...
    },
    {
      ...
      description:
        "Grew B2B company's LinkedIn following by 300% and generated 200+ qualified leads.",
    ...
    },
    {
      ...
      description:
        '3-day conference with 1,000+ attendees, achieving 98% satisfaction rating.',
    ...
    },
    {
      ...
      description:
        'Multi-channel campaign delivering 5x ROAS and scaling budget from $10K to $100K monthly.',
