  ...
  const resources = [
    {
      ...
      category: "Branding",
      description: "Comprehensive template for developing your brand strategy and positioning.",
      price: "Free",
      rating: 4.8,
      downloads: "2.5K",
    },
    {
      ...
      description: "Plan and organize your social media content for maximum engagement.",
      price: "$29",
      rating: 4.9,
      downloads: "1.8K",
    },
    {
      ...
      category: "Marketing",
      description: "Calculate and track the return on investment for your marketing campaigns.",
      price: "Free",
      rating: 4.7,
      downloads: "3.2K",
    },
    {
      ...
      description: "Ensure your website meets all best practices for design and user experience.",
      price: "$19",
      rating: 4.6,
      downloads: "1.5K",
    },
    ...
    },
    {
      ...
      description: "Professional media kit template to pitch your story to journalists.",
      price: "Free",
      rating: 4.8,
      downloads: "2.1K",
    },
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-pretty text-lg text-muted-foreground md:text-xl">
              Access premium templates, tools, and resources to accelerate your marketing and business growth. From free
              downloads to premium packages, find everything you need to succeed.
            </p>
          </div>
        </div>
      </section>
            ...
            {resources.map((resource, index) => (
              <Card key={index} className="group transition-all hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <Button className="w-full" variant={resource.price === "Free" ? "outline" : "default"}>
      ...
      <section className="border-t bg-muted/30 py-20">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Need Custom Solutions?</h2>
